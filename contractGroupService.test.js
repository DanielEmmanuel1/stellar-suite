...
const contractGroupService_1 = require("../services/contractGroupService");
/**
...
class MockExtensionContext {
    ...
    getWorkspaceState() {
        return {
            get: (key) => this.workspaceState.get(key),
...
suite('ContractGroupService', () => {
    ...
    setup(() => {
        ...
        groupService = new contractGroupService_1.ContractGroupService(mockContext.getWorkspaceState());
    });
    ...
    suite('Import/Export', () => {
        ...
        test('should import groups from JSON', () => {
            ...
            groupService.addContractToGroup('contract1', group1.id);
            const json = groupService.export();
            const newService = new contractGroupService_1.ContractGroupService(mockContext.getWorkspaceState());
...
//# sourceMappingURL=contractGroupService.test.js.map